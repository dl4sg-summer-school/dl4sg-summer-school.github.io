...
<div class="page-container panels-page">
  ...
  <div class="panels-list">
    <section class="panel-session-card">
      ...
      <p class="panel-session-meta"><strong>Chair:</strong> <a href="https://profiles.cardiff.ac.uk/staff/mintor">Dr. Rachel Minto</a></p>
    ...
    <section class="panel-session-card">
      ...
      <p class="panel-session-meta"><strong>Chair:</strong> Dr. Thanos Goltsos</p>
      <div class="panel-people-grid">
        <article class="panel-person-card">
