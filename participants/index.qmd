...
<div class="page-container">
    ...
    <div class="content-card">
        <div class="participants-grid">
            ...
            <div class="participant-card">
                <img src="img/Charlie Leedham.jpeg" alt="Charlie Leedham" class="participant-avatar">
                <div class="participant-name">Charlie Leedham</div>
                <div class="participant-affiliation">Cardiff University</div>
                <div class="participant-links">
                    <a href="https://www.linkedin.com/in/charlie-leedham-378756182" title="LinkedIn" aria-label="LinkedIn"><i class="bi bi-linkedin"></i></a>
                </div>
            ...
            <div class="participant-card">
                <img src="img/xinru liang.jpeg" alt="Xinru Liang" class="participant-avatar">
                <div class="participant-name">Xinru Liang</div>
                <div class="participant-affiliation">School of Engineering, Cardiff University</div>
                <div class="participant-links">
                    <a href="https://profiles.cardiff.ac.uk/staff/liangx21" title="Profile" aria-label="Profile"><i class="bi bi-globe"></i></a>
                </div>
            </div>
            ...
            <div class="participant-card">
                <img src="img/Agnes Njambi.jpg" alt="Agnes Njambi Wanjau" class="participant-avatar">
                <div class="participant-name">Agnes Njambi Wanjau</div>
                <div class="participant-affiliation">The Alliance of Bioversity International and CIAT</div>
                <div class="participant-links">
                    <a href="https://orcid.org/0009-0005-7706-5640" title="ORCID" aria-label="ORCID"><i class="bi bi-fingerprint"></i></a>
                </div>
            </div>
